...
class AuthManager {
    private PDO $pdo;
    private const SESSION_TIMEOUT = 1800; // 30 دقیقه
    ...
    private function checkSessionTimeout(): void {
        if (isset($_SESSION['last_activity']) && (time() - $_SESSION['last_activity']) > self::SESSION_TIMEOUT) {
            session_unset();
            session_destroy();
            throw new Exception('سشن شما منقضی شده است. لطفاً دوباره وارد شوید.');
        }
    ...
    public function login(string $username, string $password, string $csrf_token): array {
        try {
            ...
            if (!$user || !password_verify($password, $user['password_hash'])) {
                $this->logError("Failed login attempt for username: $username");
                return [
                    'success' => false,
                    'status' => 401,
            ...
            // بازتولید ID سشن برای امنیت بیشتر
            ...
            return [
                ...
                'redirect' => 'https://photonima.ir/app/Nima%20Studio.html'
            ];
        } catch (Exception $e) {
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $response = $authManager->login($username, $password, $csrf_token_input);
...
<head>
    ...
    <meta name="description" content="ورود به نرم‌افزار مدیریت حرفه‌ای استودیو نیما">
    <meta name="robots" content="noindex, nofollow">
    <link rel="icon" href="https://photonima.ir/app/Image/Logo1.png" type="image/png" sizes="80x80">
    <title>نیما | ورود</title>
...
<body>
    ...
    <div class="container fade-in">
        <img src="https://photonima.ir/app/Image/Logo2.png" alt="نیما استودیو" class="logo">
        <h2 class="title">استودیو نیما</h2>
        <p class="subtitle">نرم‌افزار مدیریت مشتری و سفارشات نیما</p>
        ...
        <form id="login-form" method="POST">
            ...
            <button type="submit" class="submit-btn"><i class="fas fa-sign-in-alt"></i> ورود</button>
        </form>

        <br><br>
        <p>برای ورود افراد عادی از نام کاربری admin و کلمه عبور admin123 استفاده کنید.</p>
    </div>
